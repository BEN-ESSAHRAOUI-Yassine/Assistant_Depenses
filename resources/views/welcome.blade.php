        ...
        <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
            <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                <div class="text-[13px] leading-[20px] flex-1 p-6 pb-6 lg:p-20 lg:pb-10 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                    <h1 class="text-2xl font-bold mb-1">Assistant Dépenses</h1>
                    <p class="mb-4 text-[#706f6c] dark:text-[#A1A09A]">
                        Gérez vos reçus et suivez vos dépenses facilement.
                    </p>
                    <p class="mb-4 text-[#706f6c] dark:text-[#A1A09A]">
                        Collez le texte de vos reçus, laissez l'IA extraire les dépenses, et gardez le contrôle de votre budget.
                    </p>
                    <ul class="flex flex-col mb-4 lg:mb-6">
                        <li class="flex items-center gap-4 py-2 relative before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:top-1/2 before:bottom-0 before:left-[0.4rem] before:absolute">
                            ...
                            <span>Collez le texte de votre reçu</span>
                        </li>
                        <li class="flex items-center gap-4 py-2 relative before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:bottom-1/2 before:top-0 before:left-[0.4rem] before:absolute">
                            ...
                            <span>L'IA extrait automatiquement les dépenses</span>
                        </li>
                    </ul>
                    <ul class="flex gap-3 text-sm leading-normal">
                        @auth
                            <li>
                                <a href="{{ route('recus.index') }}" class="inline-block px-5 py-1.5 bg-[#1b1b18] rounded-sm border border-black text-white text-sm leading-normal hover:bg-black transition">
                                    Mes reçus
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('recus.create') }}" class="inline-block dark:bg-[#eeeeec] dark:border-[#eeeeec] dark:text-[#1C1C1A] dark:hover:bg-white dark:hover:border-white hover:bg-black hover:border-black px-5 py-1.5 bg-[#1b1b18] rounded-sm border border-black text-white text-sm leading-normal">
                                    Nouveau reçu
                                </a>
                            </li>
                        @else
                            <li>
                                <a href="{{ route('login') }}" class="inline-block px-5 py-1.5 bg-[#1b1b18] rounded-sm border border-black text-white text-sm leading-normal hover:bg-black transition">
                                    Connexion
                                </a>
                            </li>
                            <li>
                ...
                <div class="bg-[#f0fdf4] dark:bg-[#052e16] relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/364] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden flex items-center justify-center">
                    <svg class="w-32 h-32 text-emerald-600 dark:text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
